...
async function loadProducts() {
    ...
    if (squarespaceProducts.length === 0) {
        if (productContainer) {
            productContainer.innerHTML = '<tr><td colspan="11" style="text-align: center; padding: 2em;">No products found or unable to fetch products.</td></tr>';
        }
        return;
    }
